...
(0, _jquery2.default)('[data-js="video-trans"]').videoTransitions({
	endText: 'Ending text',
	transTime: 1.5,
	startImage: '/media/images/start.png'
});

},{"./modules/video":7,"jquery":8}],2:[function(require,module,exports){
'use strict';
...
},{"./createCaptionsObject.js":2,"jquery":8}],4:[function(require,module,exports){
'use strict';
...
var videoSettings = function videoSettings(settings, $container) {
    ...
    _jquery2.default.extend(x, settings);
    ...
    x.start = (0, _jquery2.default)('[data-js="startpoint"]');
    x.end = (0, _jquery2.default)('[data-js="endpoint"]');
...
var videoTests = function videoTests() {
	var def = new _jquery2.default.Deferred();
	def.promise();
...
var videoTransitions = function videoTransitions(scope) {
    ...
    _jquery2.default.extend(obj, scope.customTransitions);
    if (scope.settings.userTransitions) {
        for (var transition in scope.settings.userTransitions) {
            var clone = _jquery2.default.extend({}, obj.default);
            obj[transition] = _jquery2.default.extend(clone, obj[transition]);
        }
    }
...
var Plugin = function () {
	function Plugin(el, settings) {
		...
		_jquery2.default.when(_tests2.default).done(function (bool) {
	...
	_createClass(Plugin, [{
		...
		value: function events(videoObj) {
			...
			$video.on('timeupdate', _jquery2.default.proxy(this.timing, this, videoObj));
			$video.on('ended', _jquery2.default.proxy(this.endTransition, this, videoObj));
			$video.on('error', _jquery2.default.proxy(this.videoError, this, videoObj));
		}
		...
		value: function hideCaptions($captions) {
			$captions.each(function (i, el) {
				(0, _jquery2.default)(el).addClass('inactive');
			});
		}
		...
		value: function createFallbackMarkup() {
			...
			this.$fallbackWrap = (0, _jquery2.default)('[data-js="fallbackWrap"]');
...
_jquery2.default.fn[pluginName] = function (options) {
	return this.each(function () {
		if (!_jquery2.default.data(this, "plugin_" + pluginName)) {
			return _jquery2.default.data(this, "plugin_" + pluginName, new Plugin(this, options));
		}
	});
};

},{"./submodules/createVideosObject.js":3,"./submodules/settings.js":4,"./submodules/tests.js":5,"./submodules/transitions.js":6,"jquery":8}],8:[function(require,module,exports){
/*!
