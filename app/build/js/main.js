...
(0, _jquery2.default)('[data-js="video"]').each(function (i, el) {
	return new _video2.default((0, _jquery2.default)(el), {
		looping: true,
		endText: 'Ending text',
		transTime: 1.5,
...
},{"./modules/video":2,"jquery":3}],2:[function(require,module,exports){
'use strict';
...
var VideoTransitions = function () {
	function VideoTransitions($el, settings, transitions) {
		var _this = this;

		_classCallCheck(this, VideoTransitions);
	...
	_createClass(VideoTransitions, [{
		...
		key: 'initTransObject',
		value: function initTransObject() {
			var obj = {
				default: {
					fn: this.events,
			...
			for (var transition in this.customTransitions) {
				var clone = Object.assign({}, obj.default);
		...
		value: function getVideos() {
			...
			this.$videos.each(function (i, el) {
				...
				video.captions = _this2.assignCaptions(video);
				video.error = false;

				_this2.settings.transTime ? _this2.setTransDuration(video.$wrap) : false;
				video.$wrap.addClass(_this2.classDefault);

				// when the first video can play -> go //
				video.index === 0 ? video.$element.one('canplay', function () {
					_this2.init();
				}) : false;

				// sort out transition type and fallback //
				var fn = _this2.transitions.hasOwnProperty(_this2.transitionType) ? _this2.transitions[_this2.transitionType].fn.bind(_this2) : null;

				if (fn === null) {
					console.log('You have passed an unknown transition type ' + _this2.transitionType + ' - reverting to default of fade');
					fn = _this2.transitions['default'].fn.bind(_this2);
				}
		...
		key: 'assignCaptions',
		value: function assignCaptions(video) {
			var _this3 = this;
