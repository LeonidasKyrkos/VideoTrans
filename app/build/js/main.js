...
new _video2.default((0, _jquery2.default)('[data-js="video-trans"]'), {
	endText: 'Ending text',
	transTime: 1.5,
...
var videoTransitions = function videoTransitions(scope) {
    ...
    for (var transition in scope.customTransitions) {
...
var VideoTransitions = function () {
	function VideoTransitions($el, settings, userTransitions) {
		var _this = this;
